...
void main() {
  group('CO2Calculator Tests', () {
    test('Calculates baselines correctly for a petrol car and meat heavy diet', () {
      ...
      expect(result['transport_factor'], closeTo(expectedTransportFactor, 0.001));
      ...
      expect(result['daily_energy_baseline_kwh'], closeTo(expectedDailyKwh, 0.001));

      // Daily energy CO2: 3.333 * 0.45 = 1.5
      expect(result['daily_energy_baseline_co2'], closeTo(expectedDailyKwh * 0.45, 0.001));
      ...
      expect(result['total_daily_baseline_co2'], closeTo(expectedTotal, 0.001));
    });
