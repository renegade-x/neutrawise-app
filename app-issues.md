 Define when can a challenge be taken up again after completion (challanges once completed cannot be entered again)
 User should be able to add user name and profile picture, city (profile setup details)
...
Activity logging should only award full XP once per day, 10XP for subsequent logs
