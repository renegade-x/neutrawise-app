...
-- badges
DROP POLICY IF EXISTS "Users see only their own badges" ON badges;
...
-- streaks
DROP POLICY IF EXISTS "Users see only their own streaks" ON streaks;
...
-- user_challenges
DROP POLICY IF EXISTS "Users see only their own challenges" ON user_challenges;
