...
_UserProfile _$UserProfileFromJson(Map<String, dynamic> json) => _UserProfile(
  ...
  fullLogStreakDays: (json['full_log_streak_days'] as num?)?.toInt() ?? 0,
  lastLogDate: json['last_log_date'] as String?,
  streakFreezeHeld: json['streak_freeze_held'] as bool? ?? false,
  streakFreezeQueued: json['streak_freeze_queued'] as bool? ?? false,
  lastDailyXpDate: json['last_daily_xp_date'] as String?,
  dailyXpFromLog: (json['daily_xp_from_log'] as num?)?.toInt() ?? 0,
  dailyXpFromQuiz: (json['daily_xp_from_quiz'] as num?)?.toInt() ?? 0,
...
Map<String, dynamic> _$UserProfileToJson(_UserProfile instance) =>
    <String, dynamic>{
      ...
      'lifetime_xp': instance.lifetimeXp,
      'monthly_xp': instance.monthlyXp,
      'level': instance.level,
      'streak_days': instance.streakDays,
      'full_log_streak_days': instance.fullLogStreakDays,
      'last_log_date': instance.lastLogDate,
      'streak_freeze_held': instance.streakFreezeHeld,
      'streak_freeze_queued': instance.streakFreezeQueued,
      'last_daily_xp_date': instance.lastDailyXpDate,
      'daily_xp_from_log': instance.dailyXpFromLog,
      'daily_xp_from_quiz': instance.dailyXpFromQuiz,
      'xp': instance.xp,
